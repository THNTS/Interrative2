...
description1.innerText =
  "1. Whrite a greeting with first_name property from function";
const answer1 = document.createElement("div");
const one = (first_name) => {
  // TODO return a Hello greeting with the first_name property using Template Literals

  return `Hello ${first_name}`;
};

answer1.innerHTML = `<b>Answer: </b> ${one("Julia")}`;
...
description2.innerText = `2. Lets display all the numbers with " - " between`;
const answer2 = document.createElement("div");
const two = () => {
  // TODO return a string with all the number in the number array with a ' - ' between
  const numbers = [3, 25, 100, 5, 9, 12, 16, 9, 0, 456, 6, 34, 5];
  return numbers.join("-");
};
...
description4.innerText = "4. Lets make these 2 arrays into 1";
const answer4 = document.createElement("div");
const four = () => {
  // TODO: Write a function that adds these arrays together, with using Spread
  const firstHalf = [1, 2, 3, 4, 5];
  const secondHalf = [6, 7, 8, 9, 10];
...
description5.innerText = "5. Return an ";
const answer5 = document.createElement("div");
const five = () => {
  // TODO: Write a function that return the fruits object with an extra property description
  // for example { name: "Strawberry", color: "red", description: "Strawberry is red" }
  const fruits = [
    { name: "Lemon", color: "yellow" },
    { name: "Strawberry", color: "red" },
    { name: "Orance", color: "orange" },
  ];
  return fruits.map((fruit) => ({
    ...fruit, description: `${fruit.name} is ${fruit.color}`
  }));
};
...
description6.innerText = "6. Alphabetical sort";
const answer6 = document.createElement("div");
const six = () => {
  // TODO: Write a function that gives us the names sorted alphabetically
  const names = [
    "Fred",
    "Mark",
    "Michelle",
...
description7.innerText = "7. Filter out Lemon from the array";
const answer7 = document.createElement("div");
const seven = () => {
  // TODO: Write a function that filters out Lemon from the array
...
description8.innerText = "8. Multiply numbers in array";
const answer8 = document.createElement("div");
const eight = () => {
  // TODO: Write a function that returns the array numbers with multiplied numbers
...
description11.innerText = "11. How many numbers are in the array";
const answer11 = document.createElement("div");
const eleven = () => {
  // TODO: Write a function that return how many numbers are in the array
...
description13.innerText = "13. Find the lemon object in the array";
const answer13 = document.createElement("div");
const thirteen = () => {
  // TODO: Write a function that finds the lemon object
  const fruits = [
    { name: "Orange", color: "orange" },
    { name: "Lemon", color: "yellow" },
  ];
  return fruits.find(fruit => fruit.name === "Lemon");
};
...
description14.innerText =
  "14. Return the color of the lemon by using ES6 destructuring";
const answer14 = document.createElement("div");
const fourteen = () => {
  // TODO: Write a function that returns the color of the lemon by destructuring
...
description15.innerText = "15. Return from the Orange to the Lemon";
const answer15 = document.createElement("div");
const fifteen = () => {
  // TODO: Write a function that finds the second largest number in an array.
